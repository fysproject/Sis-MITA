...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
    $link_halaman .= "<li><a href='hal-journal-$_GET[kat]-1.mu'><span aria-hidden='true'>&larr;</span> Awal</a></li>
					  <li><a href='hal-journal-$_GET[kat]-$prev.mu'><span aria-hidden='true'>&laquo;</span></a></li>";
}
else{ 
	$link_halaman .= "<li><a href=''><span aria-hidden='true'>&larr;</span> Awal</a></li>
					  <li><a href=''><span aria-hidden='true'>&laquo;</span></a></li>";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<li><a href='hal-journal-$_GET[kat]-$i.mu'>$i</a></li>";
  }
	  $angka .= " <li class='active'><a href=''>$halaman_aktif</a></li>";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <li><a href=''>...</a></li><li><a href=hal-journala-$_GET[kat]-$jmlhalaman.mu>$jmlhalaman</a></li>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= "<li><a href='hal-journal-$_GET[kat]-$next.mu'><span aria-hidden='true'>&raquo;</span></a></li>
                      <li><a href='hal-journal-$_GET[kat]-$jmlhalaman.mu'>Akhir <span aria-hidden='true'>&rarr;</span></a></li>";
}
else{
	$link_halaman .= "<li><a href=''><span aria-hidden='true'>&raquo;</span></a></li>
                      <li><a href=''>Akhir <span aria-hidden='true'>&rarr;</span></a></li>";
