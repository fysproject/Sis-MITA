	...
	if (isset($_POST[submit])){
		...
		if ($filename != ''){
			if (move_uploaded_file($_FILES['d']['tmp_name'], $uploadfile)) {
				mysql_query("INSERT INTO tbl_ins_review VALUES('','$_GET[id]','$_SESSION[id]','$filenamee','$sekarangi')");
			}
		}else{
				mysql_query("INSERT INTO tbl_ins_review VALUES('','$_GET[id]','$_SESSION[id]','','$sekarangi')");
		}
