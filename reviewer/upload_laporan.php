	...
	if (isset($_POST[submit])){
		...
		if ($filename != ''){
			if (move_uploaded_file($_FILES['d']['tmp_name'], $uploadfile)) {
				mysql_query("INSERT INTO tbl_dokrevimlap VALUES('','$_GET[id]','$_SESSION[id]','$filenamee','$sekarangi')");
			}
		}else{
				mysql_query("INSERT INTO tbl_dokrevimlap VALUES('','$_GET[id]','$_SESSION[id]','','$sekarangi')");
		}
...
<form action='' method='POST' class="form-horizontal" role="form" enctype='multipart/form-data'>
	<div class="form-group">
		<label for='inputEmail3' class='col-sm-1 control-label'>Dokumen Laporan</label>
