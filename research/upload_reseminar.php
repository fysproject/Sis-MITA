	...
	if (isset($_POST[submit])){
		...
		if ($filename != ''){
			if (move_uploaded_file($_FILES['d']['tmp_name'], $uploadfile)) {
				mysql_query("INSERT INTO tbl_dokreseminar VALUES('','$_GET[id]','$_SESSION[id]','$filenamee','$sekarangi')");
			}
		}else{
				mysql_query("INSERT INTO tbl_dokreseminar VALUES('','$_GET[id]','$_SESSION[id]','','$sekarangi')");
		}
...
<form action='' method='POST' class="form-horizontal" role="form" enctype='multipart/form-data'>
	<div class="form-group">
		...
		<div class="input-group col-lg-9">
			<div class="col-lg-7"><input type="file" class="form-control" name='d' placeholder="Masukkan Dokumen Pengolahan dan Analisis Data"></div>
		</div>
	</div>
